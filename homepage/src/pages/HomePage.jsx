...
const HomePage = () => {
  ...
  return (
    <div className="min-h-screen bg-[#f3f3f3] text-gray-900 font-sans selection:bg-gold selection:text-white pb-24">
      ...
      >
        ...
        <div className="flex items-center gap-3">
          <button className="hidden md:block text-sm font-bold text-gray-600 hover:text-prime transition-colors px-4">
            Login
          </button>
          <motion.button 
